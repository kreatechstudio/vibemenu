...
export default function EditorSucursal({
  ...
  return (
    <Modal alCerrar={alCerrar} etiqueta={esNueva ? "Nueva sucursal" : `Editar ${sucursal.nombre}`}>
          ...
          <p className="-mt-2 text-xs text-vm-body">
            {vistaPrevia ? (
              <>
                ...
                . Pega el enlace de «Compartir» en Maps para que caiga en tu ficha, con tus reseñas.
              </>
            ) : (
